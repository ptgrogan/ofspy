...
"""
Test cases for L{ofspy.player.element} package.
"""
...
from ...player.element import Element, GroundStation, Satellite
from ...player import Contract, Data
from ...player.module import Defense, Storage, Sensor, SpaceGroundLink, InterSatelliteLink

"""
Test cases for L{ofspy.element.Element} class.
"""
...
class ElementTestCase(unittest.TestCase):
    ...
    def test_isCommissioned(self):
        ...
        self.default.commission(self.testLocs[1], self.context)
        self.assertTrue(self.default.isCommissioned())

    def test_canCommission(self):
        for l in self.testLocs:
            self.assertTrue(self.default.canCommission(l, self.context))

    def test_commission(self):
        self.assertTrue(self.default.commission(self.testLocs[1], self.context))
    ...
    def test_getCommissionCost(self):
        self.assertEqual(self.default.getCommissionCost(self.testLocs[0], self.context), 0)
        self.assertEqual(self.default.getCommissionCost(self.testLocs[1], self.context), 0)
        self.assertEqual(self.default.getCommissionCost(self.testLocs[2], self.context), 0)
        self.assertEqual(self.default.getCommissionCost(self.testLocs[3], self.context), 0)
        self.assertEqual(self.test1.getCommissionCost(self.testLocs[0], self.context), 0)
        self.assertEqual(self.test1.getCommissionCost(self.testLocs[1], self.context), 0)
        self.assertEqual(self.test1.getCommissionCost(self.testLocs[2], self.context), 0)
        self.assertEqual(self.test1.getCommissionCost(self.testLocs[3], self.context), 0)
    ...
    def test_couldTransmit(self):
        ...
        self.assertFalse(self.test1.couldTransmit(
            ...
            self.testLocs[1], self.testLocs[1], self.context))
        self.assertFalse(self.test1.couldTransmit(
        ...
        self.assertTrue(self.test2.couldTransmit(
            'pISL', self.testData[0], self.test3,
            self.testLocs[1], self.testLocs[5], self.context))
        self.assertFalse(self.test2.couldTransmit(
    ...
    def test_canTransmit(self):
        ...
        self.test1.commission(self.testLocs[1], self.context)
        self.assertFalse(self.test1.canTransmit(
            'pSGL', self.testData[0], self.test0, self.context))
        self.test1.modules[0].transferIn(self.testData[0])
        self.assertTrue(self.test1.canTransmit(
            'pSGL', self.testData[0], self.test0, self.context))

        self.test2.commission(self.testLocs[1], self.context)
        self.test3.commission(self.testLocs[5], self.context)
        self.assertFalse(self.test2.canTransmit(
            'pISL', self.testData[0], self.test3, self.context))
    ...
    def test_canReceive(self):
        ...
        self.assertTrue(self.test0.canReceive(
            'pSGL', self.testData[0], self.test1, self.context))

        self.test2.commission(self.testLocs[1], self.context)
        self.test3.commission(self.testLocs[5], self.context)
        self.assertTrue(self.test3.canReceive(
            'pISL', self.testData[0], self.test2, self.context))
    ...
    def test_transfer(self):
        ...
        self.test4.commission(self.testLocs[1], self.context)
    ...
    def test_canSense(self):
        ...
        self.test2.commission(self.testLocs[3], self.context)
    ...
    def test_getTransmitted(self):
        ...
        self.test1.modules[0].transferIn(self.testData[0])
        self.test1.transmit('pSGL', self.testData[0], self.test0, self.context)
        ...
        self.test2.modules[0].transferIn(self.testData[0])
        self.test2.transmit('pISL', self.testData[0], self.test3, self.context)
        self.assertEqual(self.test2.getTransmitted('pSGL'), 0)
    ...
    def test_getReceived(self):
        ...
        self.test0.receive('pSGL', self.testData[0], self.test1, self.context)
        ...
        self.test2.modules[0].transferIn(self.testData[0])
        self.test3.receive('pISL', self.testData[0], self.test2, self.context)
        self.assertEqual(self.test3.getReceived('pSGL'), 0)
...
"""
Test cases for L{ofspy.element.GroundStation} class.
"""
...
"""
Test cases for L{ofspy.element.Satellite} class.
"""
...
class SatelliteTestCase(unittest.TestCase):
    ...
    def test_getCommissionCost(self):
        self.assertEqual(self.test1.getCommissionCost(
            self.testLocs[0], self.context), 0)
        self.assertEqual(self.test1.getCommissionCost(
            self.testLocs[1], self.context), 0)
        self.assertEqual(self.test1.getCommissionCost(
            self.testLocs[2], self.context), 200*0.5)
        self.assertEqual(self.test1.getCommissionCost(
            self.testLocs[3], self.context), 200*1.0)
    ...
    def test_getDecommissionValue(self):
        ...
        self.test1.commission(self.testLocs[2], self.context)
        self.assertEqual(self.test1.getDecommissionValue(), (200+250+50)*0.5)
        self.test1.init(self.sim)
        self.test1.commission(self.testLocs[3], self.context)
        self.assertEqual(self.test1.getDecommissionValue(), (200+250+50)*0.5)
