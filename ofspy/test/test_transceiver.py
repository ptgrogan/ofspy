...
"""
Test cases for L{ofspy.transceiver}.
"""
...
class TransceiverTestCase(unittest.TestCase):
    ...
    def test_canTransmit(self):
        self.assertTrue(self.transceivers[0].canTransmit(
            self.testData[0], self.transceivers[1])) # no transfer out check
        self.assertTrue(self.transceivers[0].canTransmit(
            self.testData[2], self.transceivers[1])) # no transfer out check
        ...
        self.assertTrue(self.transceivers[2].canTransmit(
            self.testData[0], self.transceivers[3])) # no transfer out check
        self.assertTrue(self.transceivers[2].canTransmit(
            self.testData[2], self.transceivers[3])) # no transfer out check
        self.assertTrue(self.transceivers[2].canTransmit(
            self.testData[4], self.transceivers[3])) # no transfer out check
    ...
    def test_init(self):
        ...
        self.assertEqual(self.transceivers[0].transmitted,
                      self.transceivers[0]._initTransmitted)
        self.assertEqual(self.transceivers[0].received,
                      self.transceivers[0]._initReceived)
        
        self.transceivers[0]._initTransmitted = 1
        self.transceivers[0]._initReceived = 1
        self.transceivers[0].init(self.sim)
        self.assertEqual(self.transceivers[0].transmitted, 1)
        self.assertEqual(self.transceivers[0].received, 1)
    ...
    def test_tock(self):
        ...
        self.assertEqual(self.transceivers[0].transmitted, 0)
        self.assertEqual(self.transceivers[1].received, 0)