...
"""
Test cases for L{ofspy.entity.module}.
"""
...
class ModuleTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.cap1 = Module(0, 1, 1)
        self.cap2 = Module(0, 1, 2)
    ...
    def test_getContentsSize(self):
        self.assertIs(self.cap1.getContentsSize(), 0)
        self.assertIs(self.cap2.getContentsSize(), 0)
        
        self.cap1.transferIn(self.testData[0])
        self.assertIs(self.cap1.getContentsSize(), self.testData[0].size)
        self.cap1.transferOut(self.testData[0])
        
        self.cap2.transferIn(self.testData[0])
        self.assertIs(self.cap2.getContentsSize(), self.testData[0].size)
        self.cap2.transferIn(self.testData[1])
        self.assertIs(self.cap2.getContentsSize(), self.testData[0].size + self.testData[1].size)
        self.cap2.transferOut(self.testData[0])
        self.cap2.transferOut(self.testData[1])
        
        self.cap2.transferIn(self.testData[4])
        self.assertIs(self.cap2.getContentsSize(), self.testData[4].size)
