...
"""
Test cases for L{ofspy.entity.groundStation}.
"""
...
class GroundStationTestCase(unittest.TestCase):
    ...
    def test_canCommission(self):
        self.assertTrue(self.default.canCommission(self.testLocs[0]))
        self.assertFalse(self.default.canCommission(self.testLocs[1]))
        self.assertFalse(self.default.canCommission(self.testLocs[2]))
        self.assertFalse(self.default.canCommission(self.testLocs[3]))
        
    def test_getCommissionCost(self):
        self.assertEqual(self.test0.getCommissionCost(self.testLocs[0]), 0)
        self.assertEqual(self.test0.getCommissionCost(self.testLocs[1]), 0)
        self.assertEqual(self.test0.getCommissionCost(self.testLocs[2]), 0)
        self.assertEqual(self.test0.getCommissionCost(self.testLocs[3]), 0)
