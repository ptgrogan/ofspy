...
"""
Test cases for L{ofspy.entity.sensor}.
"""
...
class SensorTestCase(unittest.TestCase):
    ...
    def test_senseAndStore(self):
        ...
        self.assertFalse(self.sensors[0].senseAndStore(
            Orbit(0,'LEO'), Contract(Demand(0,'SAR',1))))
        for d in self.sensors[0].data.copy():
        ...
        self.assertTrue(self.sensors[2].senseAndStore(
            Orbit(0,'LEO'), Contract(Demand(0,'SAR',1))))
        for d in self.sensors[2].data.copy():
        ...
        for d in self.sensors[1].data.copy():
    ...
    def test_init(self):
        ...
        self.assertIs(self.sensors[0].sensed, self.sensors[0]._initSensed)
        
        self.sensors[0]._initSensed = 1
        self.sensors[0].init(self.sim)
        self.assertIs(self.sensors[0].sensed, 1)
    ...
    def test_tock(self):
        ...
        self.sensors[0].tick(self.sim)
        self.sensors[0].tock()
        self.assertIs(self.sensors[0].sensed, 0)