...
"""
Test cases for L{ofspy.entity.contract}.
"""
...
from ofspy.context.valueSchedule import ValueSchedule
...
class ContractTestCase(unittest.TestCase):
    ...
    def test_getValue(self):
        self.sim.init()
        self.assertIs(self.contract1.getValue(), 1)
        self.assertIs(self.contract2.getValue(), 4)
        self.sim.advance()
        self.assertIs(self.contract1.getValue(), -1)
        self.assertIs(self.contract2.getValue(), 4)
        self.sim.advance()
        self.assertIs(self.contract1.getValue(), -1)
        self.assertIs(self.contract2.getValue(), 2)
        self.sim.advance()
        self.assertIs(self.contract1.getValue(), -1)
        self.assertIs(self.contract2.getValue(), -1)
    ...
    def test_init(self):
        ...
        self.assertIs(self.contract1.elapsedTime, self.contract1._initElapsedTime)
        
        self.contract1._initElapsedTime = 1
        self.contract1.init(self.sim)
        self.assertIs(self.contract1.elapsedTime, 1)
    ...
    def test_tick(self):
        ...
        self.assertIs(self.contract1.elapsedTime, self.sim.initTime)
        self.assertIs(self.contract2.elapsedTime, self.sim.initTime)
        self.contract1.tock()
        self.contract2.tock()
        self.contract1.tick(self.sim)
        self.contract2.tick(self.sim)
        self.assertIs(self.contract1.elapsedTime, self.sim.timeStep)
        self.assertIs(self.contract2.elapsedTime, self.sim.timeStep)
    ...
    def test_tock(self):
        ...
        self.contract1.tock()
        self.contract2.tock()
        self.assertIs(self.contract1.elapsedTime, 2*self.sim.timeStep)
        self.assertIs(self.contract2.elapsedTime, 2*self.sim.timeStep)