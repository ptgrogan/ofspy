...
class Sensor(Storage):
    def __init__(self, cost=0, size=1, capacity=1, phenomenon=None, maxSensed=1):
        """
        ...
        """
        Storage.__init__(self, cost, size, capacity)
    ...
    def canSense(self, location, demand):
        ...
        return self.couldSense(data) \
                ...
                and location.altitude is not "GEO" \
                and demand.sector is location.sector
    ...
    def couldTransferIn(self, data):
        ...
        return super(Sensor, self).couldTransferIn(data) \
                and self.phenomenon is data.phenomenon
